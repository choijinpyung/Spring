...
<div align="center" class="ipgoformbox">
	<form action="ipgoupdate" method="post" enctype="multipart/form-data">
	<input type="hidden" name="num" value="${dto.num }">
		<table class="table table-bordered">
		
			<tr>
				<td colspan="2" align="center" valign="middle"><b>상품정보수정</b></td>
			</tr>
			<tr>
				<td align="center" valign="middle" style="width: 15vh;">상품명</td>
				<td valign="middle">
					<input type="text" name="sangpum" class="form-control input_margin"
					required="required" style="width: 25vh;" value="${dto.sangpum }">
				</td>
			</tr>
			...
			<tr>
				...
				<td valign="middle">
					...
					required="required" style="width: 25vh;" value="${dto.price }">
				</td>
			</tr>
			...
			<tr>
				<td colspan="2" align="center" valign="middle">
					<button type="submit" class="ipgoform_update">저장</button>
